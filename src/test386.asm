...
initGDT:
	...
	defGDTDesc TSSU_DSEG_PROT32, 0x00004000,0x00000067,ACC_TYPE_DATA_W|ACC_PRESENT
	defGDTDesc TSSU_DSEG_PROT16, 0x00004200,0x0000002C,ACC_TYPE_DATA_W|ACC_PRESENT
